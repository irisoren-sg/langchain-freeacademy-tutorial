...
refactor_chain = chain_with_history | model

def refactor_code(code: str, language: str = "python") -> dict:
    """Refactor a code snippet and return the refactored code."""
    result = refactor_chain.invoke({
        "input": code,
        "language": language
    }, config={"configurable": {"session_id": "default"}})
    return result
...
"""
    ...
    refactor_code(sample_code, "python")
